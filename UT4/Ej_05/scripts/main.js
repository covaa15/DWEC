// con addEventListener podemos asignar distintas funciones a un evento
// y encapsular varias funciones en una anónima
...
function init() {
  ...
  //uso de función anónima, también nos permite pasar 
